...
public class ThreadTerminalChargeDetail extends AbstractThreadDisposeDataFromQueue<CmdChargeDetailReq> {
    ...
    private final static int MAX_RECORDS_PER_FILE = 50;
    ...
    private boolean appendRecord(File file, CmdChargeDetailReq chargeDetail) {
        ...
        try {
            ...
            writer.append(KKTool.getRightFillFixedLenStr(KKTool.byteArrayToHexStr(chargeDetail.getBankCardNo()), 19, ' ')).append(DELIMITER);
    ...
    private boolean renameFile(File file) {
        File newFile = new File(file.getAbsoluteFile() + ".sup");
        return file.renameTo(newFile);
    }
    
    public static void main(String[] args) {
        System.out.print(System.getProperty("os.name"));
//        ThreadTerminalChargeDetail thread = new ThreadTerminalChargeDetail();
//        thread.initFileSNo();
//        for (int i = 0;i < 100; i ++) {
//            thread.disposeCmd(new CmdChargeDetailReq());
//        }
    }
