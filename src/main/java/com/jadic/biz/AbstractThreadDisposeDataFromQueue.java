...
import com.jadic.utils.MyAbstractThread;
...
public abstract class AbstractThreadDisposeDataFromQueue<T> extends MyAbstractThread implements IAddDataToQueue<T> {
	...
	public AbstractThreadDisposeDataFromQueue() {
		this(DEFAULT_MAX_QUEUE_SIZE);
	}
	
	public AbstractThreadDisposeDataFromQueue(int maxQueueSize) {
		this.objNewData = new Object();
		int maxSize = maxQueueSize <= Integer.MAX_VALUE ? maxQueueSize : Integer.MAX_VALUE;
	...
	protected boolean isDataValid(T t) {
	    return true;
	}
